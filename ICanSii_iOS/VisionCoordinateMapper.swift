...
enum VisionCoordinateMapper {
    ...
    /// Inverse of `rightOrientedVisionUVToCaptureUV`.
    /// Convert normalized capture-image UV into Vision `.right` UV.
    @inline(__always)
    static func captureUVToRightOrientedVisionUV(_ uv: CGPoint) -> CGPoint {
